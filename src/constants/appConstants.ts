...
export const TOKEN_LABELS: Record<TokenKey, { label: string; detail: string }> =
  {
    background: { label: "Background", detail: "Tela base" },
    primary: { label: "Primary", detail: "CTA + ativo" },
    secondary: { label: "Secondary", detail: "Tonalidade de apoio" },
    card: { label: "Card", detail: "Superfícies" },
    text: { label: "Text", detail: "Conteúdo" },
  };
